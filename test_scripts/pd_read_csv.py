...
Copied from pandas/io/parsers.py
...
#@profile
def _read(filepath_or_buffer, kwds):  # start here for python profiline
...
class CParserWrapper(ParserBase):
    ...
    def read(self, nrows=None):
        try:
            data = self._reader.read(nrows)  # XXX Problem row for cparser (self._reader is imported from c extension _libs/parsers)
        except StopIteration:
